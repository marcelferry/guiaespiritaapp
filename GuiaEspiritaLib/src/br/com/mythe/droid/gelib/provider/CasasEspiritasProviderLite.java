...
public class CasasEspiritasProviderLite extends CasasEspiritasProvider {

	public static final String AUTHORITY =
        "br.com.mythe.droid.gelib.provider.CasasEspiritasProviderLite";	

	public static  final String DATABASE_NAME = "guiaespiritalite.db";
